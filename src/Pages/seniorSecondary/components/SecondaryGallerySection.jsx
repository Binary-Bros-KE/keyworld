...
export default function SecondaryGallerySection({ images = [] }) {
                    ...
                    {images.map((image, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all duration-300 flex items-center justify-center">
                                <Search className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-8 h-8" />
                            </div>
                        </div>
                    ))}
                </div>
