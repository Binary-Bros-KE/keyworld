                ...
                <div className="h-150 flex items-center justify-center bg-[url('/home/hero.png')] bg-cover bg-center">
                    <div className="text-center text-white px-4">
                        ...
                        <div className="mt-6 flex justify-center space-x-80 max-md:flex-col max-md:items-center max-md:space-x-0 max-md:space-y-4">
                            <a className="bg-primary hover:bg-primary-dark text-white px-6 py-1.5 rounded text-xl font-medium transition-all duration-200 hover:shadow-md cursor-pointer" href="/">Keyworld Academy</a>
                            <a className="bg-secondary hover:bg-secondary-dark text-white px-6 py-1.5 rounded text-xl font-medium transition-all duration-200 hover:shadow-md cursor-pointer" href="/senior-secondary">Keyworld Senior School</a>
                        </div>
                    </div>
                </div>
            </div>
